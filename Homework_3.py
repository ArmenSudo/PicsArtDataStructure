...
"""
    add1 ֆունկցիան ռեկուրսիվ ֆունկցիա է քանի որ այն սպասում է որ add1(dec(a)), b)
...
"""
    ...
    Մաթեմատիկական արտահայտություն վերադարձվող՝ 2*n:
"""
...
"""
    ...
    Մաթեմատիկական արտահայտություն վերադարձվող ՝ 
